...
const ACTIONS = [
  {
    id: 'environment',
    label: '01',
    title: 'Environmental re-engagement',
    body: 'Return to the physical world with intention.',
    items: [
  ...
  },
  {
    ...
    body: 'Slow, tactile tasks for your hands while your mind catches up.',
    items: [
    ...
    <div className="grid gap-6 md:grid-cols-2 md:gap-8">
      {ACTIONS.map((action, i) => (
        ...
        >
          ...
          <p className="mt-4 font-sans text-sm leading-relaxed text-[#9eb5a8]">{action.body}</p>
          <ul className="mt-5 space-y-2 font-sans text-sm text-[#b8cfc4]/90">
      ...
      >
        ...
        <p className="mt-4 font-sans text-sm leading-relaxed text-[#9eb5a8]">
